...
class _PaymentSuccessScreenState extends State<PaymentSuccessScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Lưu vé vào controller toàn cục
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildDetailRow('Suất chiếu', '${widget.ticket.showTime} | ${widget.ticket.showDate}', Icons.access_time_filled_rounded, const Color(0xFFFFB74D)),
                              _buildDetailRow('Ghế', widget.ticket.seats.map((s) => s.id).join(', '), Icons.event_seat_rounded, const Color(0xFF6C63FF)),
                        ...
                        Row(
                          children: List.generate(
                            ...
                            (index) => Expanded(
                              child: Container(
                                height: 2,
                                color: index % 2 == 0 ? Colors.transparent : Colors.white.withOpacity(0.1),
                              ),
                            ),
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('Tổng thanh toán', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 14)),
                              ShaderMask(
                                shaderCallback: (bounds) => const LinearGradient(
